...
```{r echo=FALSE}
d <- data.frame(
  Fonte = c('IBGE','IBGE','IBGE','IBGE','IBGE','INEP','INEP','INEP','MTE','MTE'),
  ...
  Função =  c('read_PNAD', 'read_PNADContinua', 'read_CENSO', 'read_PME', 'read_POF', 'read_CensoEscolar', 'read_CensoEducacaoSuperior','read_CensoEscolar_F2023', 'read_CAGED', 'read_RAIS'),
  Período = c('1976 a 2015', '2012-1q a 2017-4q', '2000', '2002.01 a 2015.12', '2008', '1995 a 2019', '1995 a 2022', '2006 a 2023','2009.01 a 2023.05', '1998 a 2023'),
  Subdataset = c('domicilios, pessoas', 'pessoas', 'domicilios, pessoas', 'vinculos', 'vários, ver detalhes', 'escolas, ..., ver detalhes', 'ver detalhes','ver detalhes', 'vinculos', 'estabelecimentos, vinculos')
  )
library(printr)
d
```
